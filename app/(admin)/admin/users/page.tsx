	...
	return (
		<div className="p-4 sm:p-6 md:p-8 bg-black min-h-full">
			<div className="max-w-7xl mx-auto space-y-6">
				<h1 className="text-2xl sm:text-3xl font-semibold text-white">Users</h1>
				...
				<div className="flex flex-col gap-3 sm:gap-4">
					<div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
						<input
							...
							className="w-full sm:w-64 rounded-md bg-slate-900 border border-slate-800 px-3 py-2 text-slate-200 placeholder:text-slate-500 text-sm focus:outline-none focus:ring-1 focus:ring-cyan-600"
						/>
						<button
							onClick={() => {
								setPage(1);
								...
								{users.map((u) => {
									...
									return (
										<tr key={id} className="hover:bg-slate-900/30">
											...
											<td className="px-3 sm:px-4 py-3 text-slate-400 hidden sm:table-cell text-sm">
												{u.email}
											</td>
